    ...
    if (app.position != undefined && app.position != null) {
        if (((new Date().getTime() / 1000) - app.timeLastSubmit) > 59
            ...
            $.ajax(app.SERVER_URL, {
                ...
                type: "GET",
                data: {"passcode": userPasscode, "deviceId": app.deviceId, "marker": JSON.stringify({"numOfUsers": numOfUsers, "lat": app.position.coords.latitude, "lng": app.position.coords.longitude, "accuracy": app.position.coords.accuracy, "heading": app.position.coords.heading})},
                timeout: 10000,
...
//        alert("No position available to submit." + null + "99 Red Beacons Tracker");
        navigator.notification.alert("No position available to submit.", null, "99 Red Beacons Tracker");
    }
};
...
//            alert("This passcode is not authorized. Try again or contact Britta. Your device id is: " + app.deviceId + null + "99 Red Beacons Tracker");
        ...
        if (app.forcedSubmit) {
//            alert("Success. Thank you!" + null + "99 Red Beacons Tracker");
...
app.serverError = function(request, errorType, errorMessage) {
    ...
    serverError.innerHTML = "Error: " + errorMessage + " "
            + app.getReadableTime(new Date());
    if (app.forcedSubmit) {
//        alert("Error, please check your internet connection" + null + "99 Red Beacons Tracker");
